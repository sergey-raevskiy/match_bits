...
int main()
{
    ...
    ok(match_bits(NULL, data("\xff"), "<11>") == -1);
    ok(match_bits(NULL, data("\xff"), "F") == -1);
    ...
    ok(match_bits(NULL, data("\xfe\x11\x84"), "xx xx xx") == 3);
    ok(match_bits(NULL, data("\xfe\x11\x84"), "xx <yyyy zzzz> xx") == 3);
